...
funcion.material= (callback)=>{
    db.query(`SELECT material, material_description, unidad_medida FROM material`,function (err, result) {
        if (err) {
...
//     db.query(`SELECT storage_unit FROM material`,function (err, result) {
//         if (err) {
...
//     db.query(`SELECT DISTINCT rack AS racks FROM ubicaciones_conteo WHERE storage_location = '${ubicacion}' ORDER BY rack ASC`,function (err, result) {
//         if (err) {
...
//     db.query(`SELECT DISTINCT storage_bin AS bins FROM ubicaciones_conteo WHERE rack = '${rack}' ORDER BY storage_bin ASC`,function (err, result) {
//         if (err) {
...
//     db.query(`SELECT material, stock FROM material WHERE storage_unit = ${serial}`,function (err, result) {
//         if (err) {
...
//     db.query(`SELECT captura_grupo FROM captura WHERE captura_grupo = '${captura_grupo}'`,function (err, result) {
//         if (err) {
...
funcion.Select_CapturaId= (serial,callback)=>{
    db.query(`SELECT * FROM captura WHERE serial = '${serial}'`,function (err, result) {
        if (err) {
...
//      cantidad=${cantidad}
//      WHERE serial = '${serial}'`, function (err, result) {
//         if (err) {
...
funcion.ticketsCapturados= (callback)=>{
    db.query(`SELECT serial FROM captura WHERE captura_grupo IS NULL`,function (err, result) {
        if (err) {
...
//     db.query(`SELECT serial FROM captura WHERE captura_grupo IS NOT NULL`,function (err, result) {
//         if (err) {
...
//     db.query(`SELECT captura_grupo FROM captura WHERE captura_grupo IS NOT NULL`,function (err, result) {
//         if (err) {
...
funcion.Select_Captura= (callback)=>{
    db.query(`SELECT * FROM captura `,function (err, result) {
        if (err) {
...
funcion.Select_Captura_Eliminado= (callback)=>{
    db.query(`SELECT * FROM captura_eliminado `,function (err, result) {
        if (err) {
...
//     db.query(`SELECT * FROM captura WHERE captura_grupo = '${captura_grupo}'`,function (err, result) {
//         if (err) {
...
funcion.MaxTickets= (callback)=>{
    db.query(`SELECT MIN(CONVERT(ticket_inicial, SIGNED INTEGER)) AS minimo, MAX(CONVERT(ticket_final, SIGNED INTEGER))AS maximo FROM talones`,function (err, result) {
        if (err) {
...
funcion.Talones= (callback)=>{
    db.query(`SELECT * FROM talones`,function (err, result) {
        if (err) {
...
funcion.TalonesEntregados= (callback)=>{
    db.query(`SELECT * FROM talones WHERE status='ENTREGADO'`,function (err, result) {
        if (err) {
...
funcion.Talones_Contados= (callback)=>{
    db.query(`SELECT COUNT(*) AS TalonesContados FROM talones WHERE totales = capturados`,function (err, result) {
        if (err) {
...
funcion.Talones_NoContados= (callback)=>{
    db.query(`SELECT Count(*) AS TalonesNoContados FROM talones WHERE totales != capturados`,function (err, result) {
        if (err) {
...
funcion.misTicketsCapturados= (gafete,callback)=>{
    db.query(`SELECT * FROM captura WHERE num_empleado= ${gafete} ORDER BY captura_id DESC`,function (err, result) {
        if (err) {
...
funcion.misTicketsCapturadosC= (gafete,callback)=>{
    db.query(`SELECT * FROM captura WHERE num_empleado= ${gafete} AND material= 'CANCELADO' ORDER BY captura_id DESC`,function (err, result) {
        if (err) {
...
funcion.ubicacion = (callback)=>{
    db.query(`SELECT * FROM ubicaciones`, function (err, result) {
        if (err) {
...
//     db.query(`SELECT DISTINCT LEFT(id_ubicacion,2) AS distinct_ubicacion,estado_auditoria  FROM auditoria ORDER BY estado_auditoria ASC`, function (err, result) {
//         if (err) {
...
//     db.query(`SELECT * FROM auditoria WHERE estado_auditoria = 1`, function (err, result) {
//         if (err) {
...
//     db.query(`SELECT * FROM auditoria WHERE estado_auditoria = 0`, function (err, result) {
//         if (err) {
...
//     db.query(`SELECT * FROM captura WHERE LEFT(ubicacion,2) = '${ubicacion}'`, function (err, result) {
//         if (err) {
...
//     db.query(`SELECT * FROM captura WHERE LEFT(ubicacion,2) = '${ubicacion}' AND serial_auditado = 1`, function (err, result) {
//         if (err) {
...
//     db.query(`SELECT * FROM captura WHERE LEFT(ubicacion,2) = '${ubicacion}' AND serial_auditado IS NULL`, function (err, result) {
//         if (err) {
...
//     db.query(`UPDATE captura SET serial_auditado = 1 WHERE serial = ${serial_auditado}`, function (err, result) {
//         if (err) {
...
//     db.query(`UPDATE auditoria SET estado_auditoria = 1 WHERE LEFT(id_ubicacion,2) = '${ubicacion}'`, function (err, result) {
//         if (err) {
...
funcion.DeleteTicket= (idTicket,callback)=>{
    db.query(`DELETE FROM captura WHERE serial='${idTicket}'`, function (err, result) {
        if (err) {
...
funcion.DeleteTalon= (idTicket,callback)=>{
    db.query(`DELETE FROM talones WHERE id='${idTicket}'`, function (err, result) {
        if (err) {
...
funcion.DeleteUbicacion= (idTicket,callback)=>{
    db.query(`DELETE FROM ubicaciones WHERE id=${idTicket}`, function (err, result) {
        if (err) {
...
funcion.CountTicketsCapturados= (callback)=>{
    db.query(`SELECT COUNT (serial) AS TCapturados FROM captura WHERE captura_grupo IS NULL`, function (err, result) {
        if (err) {
...
funcion.CountSerialesTotales= (callback)=>{
    db.query(`SELECT COUNT (material_id) AS STotales FROM material WHERE storage_unit IS NOT NULL`, function (err, result) {
        if (err) {
...
funcion.CountTicketsTotales= (callback)=>{
    db.query(`SELECT SUM (totales) AS TTotales FROM talones`, function (err, result) {
        if (err) {
...
funcion.UpdateStatus = (idTicket, newStatus,callback)=>{
    db.query(`UPDATE talones SET status = '${newStatus}' WHERE id = ${idTicket} `, function (err, result) {
        if (err) {
            callback(err, null);
        } else {
            callback(null, result);
...
funcion.CountTalonesP= (callback)=>{
    db.query(`SELECT * FROM talones WHERE status="PENDIENTE" `, function (err, result) {
        if (err) {
...
funcion.IncrementCaptura = (idTalon,callback)=>{
    db.query(`UPDATE talones SET capturados = capturados + 1 WHERE id = ${idTalon}`, function (err, result) {
        if (err) {
...
//     db_b10.query(`SELECT * FROM etiquetas_semi WHERE linea = ${linea} AND fecha >='2019/12/09' ORDER BY id ASC`, function (err, result) {
//         if (err) {
...
//     db_b10.query(`SELECT * FROM etiquetas_semi WHERE linea = ${linea} AND no_serie_auditado IS NOT NULL AND fecha >='2019/12/09'`, function (err, result) {
//         if (err) {
